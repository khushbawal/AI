 ...
 * will run for 1000 time steps. This simulation will 
 * run through all 1000 iterations before quitting.
 * @author Khush Bawal
 */
public class VisualizeSimulation extends JFrame {
	...
	private String mapFile = "inputs/public/input04.txt";
	 ...
	 * 
	 * The map variable allows us to customize the environment to any configuration.
